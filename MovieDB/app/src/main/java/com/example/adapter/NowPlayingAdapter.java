...
import com.example.view.MovieDetailsActivity;
...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.CardViewViewHolder> {
    ...
    public class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardViewViewHolder(@NonNull View itemView) {
            ...
            lbl_overview = itemView.findViewById(R.id.subtitle_card_nowplaying);
            lbl_release_date = itemView.findViewById(R.id.releasedate_card_nowplaying);
